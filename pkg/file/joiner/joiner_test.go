...
func TestJoinerIterateChunkAddresses(t *testing.T) {
	...
	createdAddresses := []swarm.Address{}
	createdAddresses = append(createdAddresses, rootChunk.Address())
	createdAddresses = append(createdAddresses, firstAddress)
	createdAddresses = append(createdAddresses, secondAddress)
