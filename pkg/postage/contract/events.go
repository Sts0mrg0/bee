...
func (e *batchCreatedEvent) Update(s postage.BatchStore) error {
...
func (e *batchTopUpEvent) Update(s postage.BatchStore) error {
...
func (e *batchDepthIncreaseEvent) Update(s postage.BatchStore) error {
...
func (e *priceUpdateEvent) Update(s postage.BatchStore) error {
